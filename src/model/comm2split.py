...
if __name__ == "__main__":
    ...
    st = CommunityStratification(num_subsamples=20000, num_communities=10, walk_size=4, sigma=2,
                                 ...
                                 shuffle=True, split_size=0.75, batch_size=500, num_epochs=50,
                                 num_jobs=2)
